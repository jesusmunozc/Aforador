...
class VentanaSeleccion(tk.Tk):
    def __init__(self):
        ...
        self.dropdown = tk.OptionMenu(self.marco, self.var_cantidad, *self.opciones, command=self.mostrar_cuadros_texto)
        self.dropdown.pack()
    ...
    def mostrar_cuadros_texto(self, seleccion):
        cantidad = int(seleccion)
    ...
    def abrir_ventana_control(self):
        ...
        self.cerrar_ventana_seleccion(cantidad, nombres)
    ...
    def cerrar_ventana_seleccion(self, cantidad, nombres):
        if self.ventana_seleccion:
